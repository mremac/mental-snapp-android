...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabImageView != null) {
                setTabIcon(tabImageView, (((SlidePagerAdapter) adapter).getPageImage(i)));
            }
    ...
    private void setTabIcon(ImageView imageView, String imageUrl) {
        if (!TextUtils.isEmpty(imageUrl)) {
            GlideUtils.loadImage(getContext(), imageUrl, imageView, R.drawable.default_category_icon);
        } else {
